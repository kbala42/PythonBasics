"""
Kodlama egzersizimizde bir sınıfın harf notlarını hesapladığımız programı geliştirerek kalanları "kalanlar.txt" dosyasında
    ve
...
with open("GecisNotu.txt","w",encoding="utf-8") as file2:

    for i in istenenListe:
        file2.write(i)